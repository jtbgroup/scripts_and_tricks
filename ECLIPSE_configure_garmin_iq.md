...
[Reference] (https://forums.garmin.com/developer/connect-iq/i/bug-reports/simulator-not-working-on-ubuntu-19-04)
...
### 2. ENV VAR
In your ~/.bashrc, at the end, add the following ines:
